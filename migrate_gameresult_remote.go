...
// migrateGameIDs 源库中要迁移的游戏 ID 列表（先只测一个；需要批量时在此追加）
var migrateGameIDs = []int{
	3,
	// 25, 28, 29, 36, 58, 59, 62, 64, 67, 70, 79, 82, 83, 85, 86, 88, 91, 92, 94, 100, 102, 107, 108, 113, 119, 120, 121, 129, 1338274, 1381200, 1397455, 1418544, 1420892, 1432733, 1448762, 1473388, 1529867, 1555350, 1568554, 1594259, 1615454, 1648578, 1702123, 1755623, 1760238, 1778752, 1804577, 1815268, 1834850, 1849515, 1865521, 1881268, 1929177, 1940257, 1964781,
}
